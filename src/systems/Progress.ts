...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  },
  {
    id: "zombie_slayer",
    title: "Вечный страж",
    description: "Упокоить 25 зомби.",
    icon: "⚔",
    rewardCoins: 500,
  },
  {
    id: "headless_hunter",
    title: "Безголовая охота",
    description: "Упокоить безголового зомби.",
    icon: "☬",
    rewardCoins: 120,
  },
  {
    id: "tycoon_5000",
    title: "Некроолигарх",
    description: "Накопить 5000₽.",
    icon: "◈",
    rewardCoins: 750,
  },
  {
    id: "fifty_graves",
    title: "Кладбище-легенда",
    description: "Сдать 50 заказов.",
    icon: "☠",
    rewardCoins: 1000,
  },
  {
    id: "hundred_graves",
    title: "Величие смерти",
    description: "Сдать 100 заказов.",
    icon: "♔",
    rewardCoins: 2500,
  },
  {
    id: "streak_14",
    title: "Постоянство",
    description: "Заходить в игру 14 дней подряд.",
    icon: "✹",
    rewardCoins: 500,
  },
  {
    id: "first_upgrade",
    title: "Инструмент мастера",
    description: "Купить первый апгрейд лопаты.",
    icon: "⛏",
    rewardCoins: 50,
  },
  {
    id: "mythril_shovel",
    title: "Мифриловая лопата",
    description: "Купить высший апгрейд лопаты.",
    icon: "❖",
    rewardCoins: 500,
  },
  {
    id: "rain_survivor",
    title: "Закаленный",
    description: "Работать под дождём.",
    icon: "☂",
    rewardCoins: 60,
  },
  {
    id: "fog_walker",
    title: "Туманный страж",
    description: "Выжить в густом тумане.",
    icon: "≈",
    rewardCoins: 60,
  },
  {
    id: "night_owl",
    title: "Ночная смена",
    description: "Играть после полуночи (00:00 в игре).",
    icon: "☾",
    rewardCoins: 80,
  },
  {
    id: "flower_lover",
    title: "Любитель цветов",
    description: "Посадить 30 цветов.",
    icon: "✿",
    rewardCoins: 120,
  },
  {
    id: "path_master",
    title: "Брусчатник",
    description: "Проложить 30 плиток дорожки.",
    icon: "▦",
    rewardCoins: 180,
  },
  {
    id: "collector",
    title: "Коллекционер",
    description: "Установить все типы надгробий хотя бы по разу.",
    icon: "✦",
    rewardCoins: 600,
  },
];
